...
const slc = () => {
  ...
  return (
    ...
    <h1 className='slc-heading'>SLC Download</h1>
    <div className="links-grid">
    <Link href="#" className="link-item" target="_blank">SLC 1</Link>
    <Link href="#" className="link-item" target="_blank">SLC 2</Link>
    <Link href="#" className="link-item" target="_blank">SLC 3</Link>
    <Link href="#" className="link-item" target="_blank">SLC 4</Link>
    <Link href="#" className="link-item" target="_blank">SLC 5</Link>
    <Link href="#" className="link-item" target="_blank">SLC 6</Link>
